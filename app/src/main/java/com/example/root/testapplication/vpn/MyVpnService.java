...
public class MyVpnService extends VpnService implements Handler.Callback {
    ...
    public void onCreate() {
        ...
        mConfigureIntent = PendingIntent.getActivity(this, 0, new Intent(this, Main4Activity.class),
    ...
    private void connect() {
        ...
        final SharedPreferences prefs = getSharedPreferences(Main4Activity.Prefs.NAME, MODE_PRIVATE);
        final String server = prefs.getString(Main4Activity.Prefs.SERVER_ADDRESS, "");
        final byte[] secret = prefs.getString(Main4Activity.Prefs.SHARED_SECRET, "").getBytes();
        final int port;
        try {
            port = Integer.parseInt(prefs.getString(Main4Activity.Prefs.SERVER_PORT, ""));
        } catch (NumberFormatException e) {
            Log.e(TAG, "Bad port: " + prefs.getString(Main4Activity.Prefs.SERVER_PORT, null), e);
            return;
        }
